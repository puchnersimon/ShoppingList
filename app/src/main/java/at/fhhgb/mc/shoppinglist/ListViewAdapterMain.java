...
class ListViewAdapterMain extends ArrayAdapter<String> {
    ArrayList<String> list;
    Context context;

    // The ListViewAdapter Constructor
    public ListViewAdapterMain(Context context, ArrayList<String> items) {
        super(context, R.layout.list_row_main, items);
